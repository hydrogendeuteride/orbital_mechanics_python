...
def plot_n_orbits(rs, labels, cb = pd.earth, final_val = False, axes = False, AU = False, ER = False, show_plot = False, save_plot = False, figsize = figsize, title = 'Test', dpi = 500):
